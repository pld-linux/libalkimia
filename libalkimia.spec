...
cd build
%cmake .. \
	-DQML_INSTALL_DIR=$(qmake-qt5 -query QT_INSTALL_QML)
%{__make}
...
%attr(755,root,root) %{_libdir}/qt5/qml/org/kde/alkimia/libqmlalkimia.so
%{_libdir}/qt5/qml/org/kde/alkimia/qmldir
